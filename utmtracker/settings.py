...
DEBUG = True
ALLOWED_HOSTS: list[str] = ['http://89.39.95.53:8002/']
...
QP_CREATOR_PASSWORD = os.environ.get('QP_CREATOR_PASSWORD', '')  # задаёшь в окружении
QP_VIEWER_PASSWORD  = os.environ.get('QP_VIEWER_PASSWORD',  '')  # задаёшь в окружении